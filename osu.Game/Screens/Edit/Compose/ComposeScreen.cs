...
namespace osu.Game.Screens.Edit.Compose
{
    public partial class ComposeScreen : EditorScreenWithTimeline, IGameplaySettings
    {
        ...
        protected override IReadOnlyDependencyContainer CreateChildDependencies(IReadOnlyDependencyContainer parent)
        {
            ...
            dependencies.CacheAs(new SectionGimmickEditorModel(parent.Get<EditorBeatmap>()));
        ...
        protected override Drawable CreateTimelineContent()
        {
            ...
            TimelineSectionGimmickDisplay sectionGimmickDisplay = new TimelineSectionGimmickDisplay
            {
                RelativeSizeAxes = Axes.Both,
                Anchor = Anchor.CentreLeft,
                Origin = Anchor.CentreLeft,
            ...
            TimelineHitObjectGimmickLineDisplay objectGimmickDisplay = new TimelineHitObjectGimmickLineDisplay
            {
                RelativeSizeAxes = Axes.Both,
                Anchor = Anchor.CentreLeft,
                Origin = Anchor.CentreLeft,
